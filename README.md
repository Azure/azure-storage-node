...
> This README page is a reference to the SDK v2. For the new SDK v12, go to [Storage SDK v12 for JavaScript](https://github.com/Azure/azure-sdk-for-js/tree/master/sdk/storage).
