...
describe('tableservice-tests', function () {
  ...
  describe('getUrl', function(){
    it('should work', function(done) {
        ...
        assert.strictEqual(parsedUrl.query, 'se=2016-10-12T11%3A53%3A40Z&sp=r&spr=https&sv=2015-12-11&tn=table1&sig=2NULkHgRyGcXosTM1SUASUbiw8reKoC8GZcXLBNESjk%3D');
        done();
    });
