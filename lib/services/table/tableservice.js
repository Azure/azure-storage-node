...
TableService.prototype.listTablesSegmentedWithPrefix = function (prefix, currentToken, optionsOrCallback, callback) {
  ...
  TableService._setTableRequestHeadersAndBody(webResource, null, options.payloadFormat);
...
TableService.prototype.createTable = function (table, optionsOrCallback, callback) {
  ...
  TableService._setTableRequestHeadersAndBody(webResource, tableDescriptor);
...
TableService.prototype.deleteTable = function (table, optionsOrCallback, callback) {
  ...
  TableService._setTableRequestHeadersAndBody(webResource);
...
TableService.prototype._performEntityOperation = function (operation, table, entityDescriptor, optionsOrCallback, callback) {
  ...
  var webResource = TableService._constructEntityWebResource(operation, table, entityDescriptor, options);
...
* @ignore
*/
TableService._constructEntityWebResource = function (operation, table, entityDescriptor, options) {
  ...
  TableService._setTableRequestHeadersAndBody(webResource, entitySerializedDescriptor, options.payloadFormat);
...
* @ignore
*/
TableService._setTableRequestHeadersAndBody = function (webResource, body, acceptType) {
  if (body) {
    webResource.withHeader(HeaderConstants.CONTENT_LENGTH, Buffer.byteLength(body, 'utf8'))
      .withBody(body)
