...
/**
* @this {TableService}
* @param {boolean} [cosmosDbTable] The cosmosDb Validation check.
*/
TableService.prototype.setCosmosDbTable= function(cosmosDbTable){
  this.cosmosDbTable = cosmosDbTable;
}
...
TableService.prototype.getTableAcl = function (table, optionsOrCallback, callback) {
  ...
  validate.validateArgs('getTableAcl', function (v) {
    ...
    v.tableNameIsValid(table, tableService.cosmosDbTable);
    v.callback(callback);
  });
