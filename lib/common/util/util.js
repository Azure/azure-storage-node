...
exports.trimPortFromUri = function (uri) {
  ...
  if ((uri_parsed.protocol === Constants.HTTPS && uri_parsed.port == Constants.DEFAULT_HTTPS_PORT) || (uri_parsed.protocol === Constants.HTTP && uri_parsed.port == Constants.DEFAULT_HTTP_PORT)) {
    uri_parsed.host = uri_parsed.hostname;
  }
  return url.format(uri_parsed);
};
