...
exports.tableNameIsValid = function (table, callback) {
  ...
  if ((process.env.cosmosdb == "true" && /[^/?#\\]*[^/?# \\]/.test(table)) || (table.match(/^([A-Za-z][A-Za-z0-9]{2,62})$/) !== null || table === '$MetricsCapacityBlob' || table.match(/^(\$Metrics(HourPrimary|MinutePrimary|HourSecondary|MinuteSecondary)?(Transactions)(Blob|Queue|Table|File))$/) !== null))
  {
    callback();
    return true;
  } else {
