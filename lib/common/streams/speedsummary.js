...
*/
SpeedSummary.prototype.getCompletePercent = function(humanReadable, len) {
  if (typeof(humanReadable) === "number") {
    len = humanReadable;
    humanReadable = true;
  }
  var percent = 0;
  if (this.totalSize) {
    percent = (this.completeSize * 100 / this.totalSize);
